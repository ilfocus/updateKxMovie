...
- (void)viewDidLoad
{
    ...
    self.navigationItem.rightBarButtonItem = [[UIBarButtonItem alloc] initWithBarButtonSystemItem:UIBarButtonSystemItemDone target:self action:@selector(movieView)];
...
{
    NSLog(@"%s",__func__);
    XYkxMovieCtrl *vc = [[XYkxMovieCtrl alloc] init];
    vc.title = @"播放器";
